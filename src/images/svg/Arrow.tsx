...
function Arrow({ direction }: ArrowSvgInterface): JSX.Element {
  return direction === 'left' ? (
    <svg xmlns='http://www.w3.org/2000/svg' width='5.965' height='10' viewBox='0 0 5.965 10'>
      <path
    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='5.966' height='10' viewBox='0 0 5.966 10'>
      <path
        id='np_arrow_1920781_000000'
